...
const translations: I18nTable = {
  en: {
    ...
    teacherEducationPlans: {
      ...
      createSubtitle: 'Generate a weekly plan from a selected source document',
      basics: 'Basics',
      planName: 'Plan name',
      ...
      baseOnDocuments: 'Source document',
      selectOneDocument: 'Select one document',
      selectOneDocumentRequired: 'Please select a source document.',
      chooseDocument: 'Choose document',
      availableDocumentsSuffix: 'available document(s)',
      baseOnDocumentsHint: 'A source document is required.',
      noDocumentsYet: 'No documents yet',
    ...
    teacherLessonGenerate: {
      ...
      sourceDocumentsRequiredHint: 'Select at least one uploaded document. Generation uses your document content (RAG).',
  ...
  az: {
    ...
    teacherEducationPlans: {
      ...
      createSubtitle: 'Seçilmiş mənbə sənədindən həftəlik plan yaradın',
      basics: 'Əsaslar',
      planName: 'Plan adı',
      ...
      baseOnDocuments: 'Mənbə sənəd',
      selectOneDocument: 'Bir sənəd seçin',
      selectOneDocumentRequired: 'Zəhmət olmasa mənbə sənədi seçin.',
      chooseDocument: 'Sənəd seçin',
      availableDocumentsSuffix: 'mövcud sənəd',
      baseOnDocumentsHint: 'Mənbə sənədi mütləqdir.',
      noDocumentsYet: 'Hələ sənəd yoxdur',
    ...
    teacherLessonGenerate: {
      ...
      sourceDocumentsRequiredHint: 'Ən azı bir yüklənmiş sənəd seçin. Yaratma sənəd məzmununa (RAG) əsaslanır.',
    ...
    teacherExamCreate: {
      ...
      selectDocumentsRequiredHint: 'Ən azı bir sənəd mütləqdir.',
