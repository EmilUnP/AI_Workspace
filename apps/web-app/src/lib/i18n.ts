...
const translations: I18nTable = {
  en: {
    ...
    teacherEducationPlans: {
      ...
      basics: 'Basics',
      planName: 'Plan name',
      classGroupOptional: 'Class group (optional)',
      selectClassOptional: 'Select class (optional)',
    ...
    teacherApiIntegration: {
      ...
      manageApiKeysDescription: 'Manage integration keys for app workflows. Keep keys secret and rotate regularly.',
      ...
      usageAnalyticsDescription: 'Track API usage by key and endpoint. Filter and sort to see what matters.',
      totalRequests: 'Total requests',
      successful: 'Successful',
      failed: 'Failed',
      successRate: 'Success rate',
      noUsageYet: 'No usage yet',
      usageWillAppear: 'When you call the API with your key, requests will appear here.',
      key: 'Key',
      allKeys: 'All keys',
      ...
      jwtAuthDescription: 'Authentication currently uses JWT access tokens.',
      baseUrlLabel: 'Base URL',
      quickStartWorkingNow: 'Quick start (working now)',
      quickStartStep1: '1) Login and get',
      quickStartStep2: '2) Use the access token in every protected request:',
      ...
      sendAuthorizationHeader: 'Send',
      onEveryProtectedRoute: 'on every protected route.',
      accessTokenComesFrom: 'Access token comes from',
  ...
  az: {
    ...
    teacherEducationPlans: {
      ...
      basics: 'Əsaslar',
      planName: 'Plan adı',
      classGroupOptional: 'Sinif qrupu (opsional)',
      selectClassOptional: 'Sinif seçin (opsional)',
      ...
      nameAndClassRequired: 'Ad və sinif vacibdir.',
    ...
    teacherApiIntegration: {
      ...
      manageApiKeysDescription: 'Tətbiq iş axınları üçün inteqrasiya açarlarını idarə edin. Açarları gizli saxlayın və mütəmadi yeniləyin.',
      ...
      usageAnalyticsDescription: 'API istifadəsini açar və endpoint üzrə izləyin. Vacib olanı görmək üçün filtrləyin və sıralayın.',
      totalRequests: 'Ümumi sorğu',
      successful: 'Uğurlu',
      failed: 'Uğursuz',
      successRate: 'Uğur faizi',
      noUsageYet: 'Hələ istifadə yoxdur',
      usageWillAppear: 'Açarınızla API çağırdıqda sorğular burada görünəcək.',
      key: 'Açar',
      ...
      jwtAuthDescription: 'Hazırda autentifikasiya JWT access token ilə işləyir.',
      baseUrlLabel: 'Baza URL',
      quickStartWorkingNow: 'Tez başlanğıc (hazırda işləyir)',
      quickStartStep1: '1) Daxil olun və alın',
      quickStartStep2: '2) Hər qorunan sorğuda access token istifadə edin:',
      ...
      sendAuthorizationHeader: 'Göndərin',
      onEveryProtectedRoute: 'bütün qorunan route-larda.',
      accessTokenComesFrom: 'Access token buradan alınır:',
