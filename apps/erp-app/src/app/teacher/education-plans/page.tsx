    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center justify-between gap-4 sm:justify-end">
          ...
          <Link
            href="/teacher/education-plans/create"
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <form className="relative flex-1 sm:max-w-sm" method="get" action="/teacher/education-plans">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          {classes.length > 0 && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-1">
                <Link
                  href={params.shared ? `/teacher/education-plans?shared=${params.shared}` : '/teacher/education-plans'}
                ...
                {classes.map((c) => (
                  <Link
                    key={c.id}
                    href={`/teacher/education-plans?classId=${c.id}${params.shared ? `&shared=${params.shared}` : ''}${params.search ? `&search=${encodeURIComponent(params.search)}` : ''}`}
                    className={`whitespace-nowrap rounded-md px-2.5 py-1.5 text-xs font-medium transition-colors ${
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <Link
              href={params.classId ? `/teacher/education-plans?classId=${params.classId}` : '/teacher/education-plans'}
            ...
            <Link
              href={params.classId ? `/teacher/education-plans?shared=shared&classId=${params.classId}` : '/teacher/education-plans?shared=shared'}
              className={`whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium transition-colors ${
            ...
            <Link
              href={params.classId ? `/teacher/education-plans?shared=not_shared&classId=${params.classId}` : '/teacher/education-plans?shared=not_shared'}
              className={`whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium transition-colors ${
            ...
            <div className="divide-y divide-gray-100 sm:hidden">
              {plans.map((plan) => (
                <div key={plan.id} className="p-4">
                  <Link href={`/teacher/education-plans/${plan.id}`} className="flex items-start gap-3">
                  ...
                  <div className="mt-3 flex items-center justify-between text-sm text-gray-500">
                    ...
                    <EducationPlanRowActions
                      planId={plan.id}
                      viewHref={`/teacher/education-plans/${plan.id}`}
                      editHref={`/teacher/education-plans/${plan.id}/edit`}
                ...
                {plans.map((plan) => (
                  <tr key={plan.id} className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 pl-4 pr-3 sm:pl-6">
                      <Link href={`/teacher/education-plans/${plan.id}`} className="flex items-center gap-3 group">
                        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-blue-100 text-blue-600">
                          <BookOpen className="h-5 w-5" />
                        </div>
