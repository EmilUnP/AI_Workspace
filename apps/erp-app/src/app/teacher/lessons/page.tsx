      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          {teacherClasses.length > 0 && (
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-wrap gap-1">
                <Link
                  href={params.status ? `/teacher/lessons?status=${params.status}` : '/teacher/lessons'}
                ...
                {teacherClasses.map((c) => (
                  <Link
                    key={c.id}
                    href={`/teacher/lessons?classId=${c.id}${params.status ? `&status=${params.status}` : ''}`}
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <Link
              href={params.classId ? `/teacher/lessons?classId=${params.classId}` : '/teacher/lessons'}
            ...
            <Link
              href={params.classId ? `/teacher/lessons?status=published&classId=${params.classId}` : '/teacher/lessons?status=published'}
              className={`whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium transition-colors ${
            ...
            <Link
              href={params.classId ? `/teacher/lessons?status=draft&classId=${params.classId}` : '/teacher/lessons?status=draft'}
              className={`whitespace-nowrap rounded-md px-3 py-2 text-sm font-medium transition-colors ${
