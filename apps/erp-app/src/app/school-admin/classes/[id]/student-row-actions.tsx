...
import { unenrollStudentFromClass } from './actions'
...
export function StudentRowActions({ classId, studentId, studentName }: StudentRowActionsProps) {
              ...
              <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <p className="text-gray-600 text-center text-sm sm:text-base leading-relaxed">
                    Are you sure you want to remove <strong className="font-semibold">{studentName}</strong> from this class? They can be re-enrolled later.
                  </p>
                </div>
