...
Releases: [CHANGELOG.md](../CHANGELOG.md) **0.2.5** (14 May) through **0.2.9** (15 May).
...
### Repository docs (updated for **0.2.9**)
...
6. **DB:** `npm run db:migrate` through `012` on target environment.  
